...
Bug reports use GitHub Issues. The README may contain an optional [Buy Me a Coffee](https://buymeacoffee.com/TODO_HANDLE) link; the maintainer replaces the placeholder before using it. Support buys no features. Do not add this link or any support-payment UI to the app.
